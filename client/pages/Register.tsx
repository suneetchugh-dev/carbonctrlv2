        ...
        <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} className="max-w-md mx-auto glass rounded-2xl p-8 mt-10">
          ...
          <div className="space-y-4">
            <div className="space-y-2">
              ...
              <Input placeholder="Alex" className="bg-white/5 border-white/20 text-white placeholder:text-white/40" />
            </div>
            <div className="space-y-2">
            ...
            <Button className="w-full bg-white text-black hover:bg-white/90 shadow-[0_0_25px_rgba(255,255,255,0.5)]">Create account</Button>
          </div>
        </motion.div>
      </div>
    </AppLayout>
